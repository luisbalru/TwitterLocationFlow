...
Finally, keeping in mind that I'm using Python 3.6.4, I will choose *venv* python module for create the virtual development enviroment.  More information about creating VDE with *venv* [here]()

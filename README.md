...
### Tools
[Python](https://www.python.org/) will be the programming language used. In particular, Flash framework may be used although it is not a decision totally made yet.  
